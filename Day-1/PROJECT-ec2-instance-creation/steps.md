...
## Plan terrafomm resources

Run the following command to see the execution plan the AWS resources defined in your Terraform configuration:

```
terraform plan
```

Terraform will display a plan of the changes it's going to make. Review the plan.
